...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--lr_step', type=str, default='20,45',
    ...
    self.parser.add_argument('--trainval', action='store_true',
                             help='include validation in training and '
                                  'test on test set')
    self.parser.add_argument('--half', type=bool, default=False,
                             help='train half')
    ...
    self.parser.add_argument('--val_kitti_half1', default=False, help='val kitti_half1')
    self.parser.add_argument('--val_kitti_half2', default=False, help='val kitti_half2')
    ...
    self.parser.add_argument('--match_thres', type=float, default=0.4, help='confidence thresh for match')
    ...
    self.parser.add_argument('--data_dir', type=str, default='/media/workspace/yirui/data/tracking_reid/prepared/MOT')
    ...
    self.parser.add_argument('--id_weight', type=float, default=2,
